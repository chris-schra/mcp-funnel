...
import { isMissingFileError, readDotEnvFile, resolveDotEnvPath } from './file-loader.js';
...
export class DotEnvProvider extends BaseSecretProvider {
  ...
  public constructor(config: DotEnvProviderConfig['config'], configFileDir?: string) {
    super('dotenv');
