...
import { OAuth2AuthCodeProvider } from '../../src/auth/implementations/oauth2-authorization-code.js';
...
describe('OAuth Security Tests', () => {
  ...
  describe('CSRF Protection', () => {
    ...
    it('should expire state after 10 minutes', async () => {
      ...
      // Advance time past 10 minutes (state expiry)
