...
import { BaseOAuthProvider } from '../../src/auth/implementations/base-oauth-provider.js';
import type {
  ITokenStorage,
  TokenData,
...
import type { OAuth2TokenResponse } from '../../src/auth/utils/oauth-types.js';
import {
...
describe('BaseOAuthProvider', () => {
  ...
  describe('requestTokenWithRetry', () => {
    ...
    it('should throw error after maximum retries exceeded', async () => {
      ...
      expect(makeRequest).toHaveBeenCalledTimes(MAX_RETRIES);
    });
