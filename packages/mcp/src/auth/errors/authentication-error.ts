...
export class AuthenticationError extends Error {
   ...
   */
  static invalidToken(cause?: Error): AuthenticationError {
   ...
   */
  static expiredToken(cause?: Error): AuthenticationError {
    return new AuthenticationError(
   ...
   */
  static revokedToken(cause?: Error): AuthenticationError {
    return new AuthenticationError(
   ...
   */
  static invalidClient(cause?: Error): AuthenticationError {
    return new AuthenticationError(
   ...
   */
  static accessDenied(cause?: Error): AuthenticationError {
    return new AuthenticationError(
   ...
   */
  static networkError(message: string, cause?: Error): AuthenticationError {
    return new AuthenticationError(
