...
const renderOAuthErrorPage = (error: string, description?: string): string => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
const renderInvalidRequestPage = (): string => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
const renderAuthErrorPage = (errorMessage: string): string => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
export const GetCallbackHandler: Handler = async (c) => {
  ...
  if (error) {
    ...
    return c.html(renderOAuthErrorPage(error, errorDescription), 400);
  }

  // Validate required parameters
  if (!code || !state) {
    return c.html(renderInvalidRequestPage(), 400);
  }
