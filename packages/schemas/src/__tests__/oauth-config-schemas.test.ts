...
import { TargetServerWithoutNameSchema } from '../config/TargetServerWithoutNameSchema.js';
import { AuthConfigSchema } from '../config/AuthConfigSchema.js';
import type { BearerAuthConfigZod } from '../config/BearerAuthConfigSchema.js';
import {
...
import { TransportConfigSchema } from '../config/TransportConfigSchema.js';
import { StdioTransportConfigSchema } from '../config/StdioTransportConfigSchema.js';
import { SSETransportConfigSchema } from '../config/SSETransportConfigSchema.js';
  ...
  describe('ExtendedTargetServerSchema', () => {
    describe('Legacy compatibility', () => {
      it('should accept command-only configurations', () => {
        ...
        expect(() =>
          TargetServerSchema.parse(validCommandConfig),
        ).not.toThrow();
    ...
    describe('Transport-only configurations', () => {
      ...
      it('should accept SSE transport without command', () => {
        ...
        expect(() =>
          TargetServerSchema.parse(sseTransportConfig),
        ).not.toThrow();
    ...
    describe('Combined configurations', () => {
      ...
      it('should accept transport + auth without command', () => {
        ...
        expect(() =>
          TargetServerSchema.parse(transportAuthConfig),
        ).not.toThrow();
    ...
    describe('Invalid configurations', () => {
      ...
      it('should reject configs with invalid transport type', () => {
        ...
        expect(() =>
          TargetServerSchema.parse(invalidTransportConfig),
        ).toThrow();
      });
    ...
    describe('Edge cases', () => {
      ...
      it('should handle undefined optional fields', () => {
        ...
        expect(() =>
          TargetServerSchema.parse(configWithUndefined),
        ).not.toThrow();
